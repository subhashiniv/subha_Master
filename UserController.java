...
public class UserController {
	 ...
	 * OneCargillConstants.APPLICATION_JSON, consumes =
	 * OneCargillConstants.APPLICATION_JSON) public void insertContract(@RequestBody
	 * UserProfileWrapper userProfileWrapper) {
	 * logger.info(":::::::::: insertContract :::::::::::::::"+userProfileWrapper);
	 * // regionFactoryService.insertContract(contract,
	 * contractCategory).insertContract(contract,userid); }
	 */
	...
	public String authenticate(@FormParam("client_id") String clientid, @FormParam("username") String username,
		...
		RestTemplate restTemplate = new RestTemplate();
		String result = restTemplate.postForObject(oktaUrl, map, String.class);
